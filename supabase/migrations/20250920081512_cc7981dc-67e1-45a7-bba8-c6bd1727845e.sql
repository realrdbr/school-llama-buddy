...
-- Fix library permissions by adding more specific permission for Level 10 users
-- Add RLS policy for Level 10+ users to access library functions
CREATE POLICY "Level 10+ users can view permissions" 
ON public.permissions 
FOR SELECT 
USING (current_user_has_permission_level(10::smallint) OR get_current_user_id() IS NOT NULL);
